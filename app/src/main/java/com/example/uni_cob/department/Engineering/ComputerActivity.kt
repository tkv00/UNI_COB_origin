...
class ComputerActivity: AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textViewTitle.text = intent.getStringExtra(ARG_TITLE) ?: "컴퓨터ㆍ통신"
