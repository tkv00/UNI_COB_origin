...
class GeneralEducationActivity:AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textViewTitle.text = intent.getStringExtra(ARG_TITLE) ?: "교육일반"
