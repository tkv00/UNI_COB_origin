...
class SocialPlus: AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.department_socialscience)
        ...
        textViewTitle.text = intent.getStringExtra(ARG_TITLE) ?: "사회과학기타"
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            ...
            R.id.socialplus->{
                val intent=Intent(this,SocialPlus::class.java)
                startActivity(intent)
            }
        }
    ...
    private fun requestApi() {
        val service = RetrofitClient.getInstance().create(ApiService_SocialScience::class.java)
