...
class electricalelectronicsActivity: AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textViewTitle.text = intent.getStringExtra(ARG_TITLE) ?: "전기ㆍ전자"
