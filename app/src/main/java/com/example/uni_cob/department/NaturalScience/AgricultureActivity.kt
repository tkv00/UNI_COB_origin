...
class AgricultureActivity:AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textViewTitle.text = intent.getStringExtra(ARG_TITLE) ?: "농림ㆍ수산"
