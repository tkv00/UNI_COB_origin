...
class BiologicalChemistryActivity:AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.department_natural)
        ...
        textViewTitle.text = intent.getStringExtra(ARG_TITLE) ?: "생물ㆍ화학ㆍ환경"
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            ...
            R.id.biological -> {
                val intent = Intent(this, BiologicalChemistryActivity::class.java)
                startActivity(intent)
            }
            R.id.humanecology->{
                val intent=Intent(this, HumanEcologyAcctivity::class.java)
                startActivity(intent)
            }
            R.id.math->{
            ...
            R.id.plus->{
                val intent=Intent(this, NaturalSciencePlusActivity::class.java)
                startActivity(intent)
            }
    ...
    private fun requestApi() {
        val service = RetrofitClient.getInstance().create(ApiService_natural_science::class.java)
