...
class Board3Detail : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_board3_detail)
        ...
        val day=intent.getStringExtra("TIME")
        val currentTime = System.currentTimeMillis()
       // val dday = TimeUnit.MILLISECONDS.toDays(day.time - currentTime)
